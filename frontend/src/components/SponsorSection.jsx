      ...
      <div className={CONTAINER}>
        <div className="grid md:grid-cols-2 gap-12 items-center max-w-7xl mx-auto">
          <div>
            ...
            <div className="text-gray-600 mb-6 leading-relaxed text-sm space-y-1" style={BODY}>
              <p>Be the Sponsor allows anyone to contribute towards someone else's healing — anonymously or intentionally.</p>
