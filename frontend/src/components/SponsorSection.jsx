...
const SponsorSection = ({ sectionConfig, inline }) => {
  ...
  return (
    <section id="sponsor" data-testid="sponsor-section" className="py-12 relative" style={{ background: 'linear-gradient(180deg, #f3edff 0%, #ffffff 10%, #ffffff 90%, #f3edff 100%)' }}>
